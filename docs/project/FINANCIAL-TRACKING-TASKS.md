...
## Current Status: Phase 0 - Bug Fix
...
- [ ] Add EmployeeType enum
- [ ] Add User model financial fields
- [ ] Extend ProjectMember model (salesRate, costRate)
- [ ] Extend HoursEntry model (revenue, cost, margin)
- [ ] Create ServiceEmployeeRate model
- [ ] Update syncEmployees() for rate fields
- [ ] Update SimplicateEmployee interface
- [ ] Run db:push and verify
